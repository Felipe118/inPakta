<template>
    <nav class="navbar">
       ...
       <ul class="navbar-menu">
           ...
           <li class="navbar-item"><a :href="route('funcionario.index') ">Funcionario</a></li>
           <li class="navbar-item"><a :href="route('empresa.index')">Empresa</a></li>
       </ul>
   ...
   <section class="container-fluid">
       <div class="row justify-content-center mt-5">
           <div class="col-6">
               ...
               <h3 style="font-size: 26px;" class="mb-4">Formulário de cadastro de funcionarios</h3>
               <form action=""  @submit.prevent="submitForm">
                   ...
                   <div class="form-group mb-5">
                       <label for="" class="form-label">Site:</label>
                        <select v-model="form.empresa_id" class="form-select input"  name="" id="">
                            <option v-for="emp in empresas.data" :key="emp.id" :value="emp.id">{{ emp.nome }}</option>
                        </select>
...
<script>
   ...
   export default {
       ...
       methods: {
            ...
            submitForm(){
               this.$inertia.post('funcionario',this.form, {
                    onSuccess: (resp) => {
                        this.message = resp
                        this.sucess = true
                        this.messageForm()
